...
/**
 * Componente Modal - Diálogo modal acessível
 ...
 * @param {ReactNode} footer - Rodapé customizado
 */
export default function Modal({ isOpen, onClose, title, children, footer, size = 'md' }) {
  ...
  return (
    ...
    >
      <div
        className={`bg-white rounded-lg sm:rounded-2xl shadow-xl w-full ${sizes[size]} max-h-[95vh] sm:max-h-[90vh] overflow-y-auto animate-fade-in`}
