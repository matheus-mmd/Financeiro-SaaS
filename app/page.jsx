    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              ...
              <span className="text-brand-600">gerenciar suas finanças</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {howItWorks.map((step, index) => (
              <div key={index} className="relative">
                <div className="text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-brand-600 text-white text-2xl font-bold mb-6">
                    {step.step}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                Por que escolher o{" "}
                <span className="text-brand-600">Financeiro SaaS</span>?
              </h2>
              ...
              <Link href="/login">
                <Button size="lg" className="mt-8 bg-brand-600 hover:bg-brand-700">
                  Começar Agora
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
              </Link>
                ...
                <CardContent className="p-0">
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between p-4 bg-danger-50 rounded-lg">
                      ...
                      <div className="text-danger-600 text-sm font-medium">-5%</div>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-accent-50 rounded-lg">
                      ...
                      <div className="text-accent-600 text-sm font-medium">+8%</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <Card className="border-0 shadow-2xl bg-brand-600 text-white overflow-hidden">
